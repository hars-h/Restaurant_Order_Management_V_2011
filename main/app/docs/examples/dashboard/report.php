...
-webkit-background-size: cover;
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h3 class="sub-header">Pending Orders</h3><h6>view more...</h6>
          <div class="table-responsive">
           ...
           <h3 class="sub-header">Today's Sale</h3><h6>view more...</h6>
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
 ...
 <h3 class="sub-header">Total Sales</h3><h6>view more...</h6>
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
