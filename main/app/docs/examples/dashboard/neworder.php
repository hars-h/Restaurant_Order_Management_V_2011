...
if(!$_SESSION['login']){
  ...
  <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="neworder.php"><button style="width:100%; color:black; height:80px"><i class="glyphicon glyphicon-pause"></i> Running Tables<span class="sr-only">(current)</span></button></a></li>
    ...
    while($row = $result->fetch_assoc()) {
            ...
            echo "<form action=\"otable.php\" method=\"post\">
