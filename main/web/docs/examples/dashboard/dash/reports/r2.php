...
<nav class="main-menu">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" style="margin-top: 60px">Category wise Summary</h1>


<!--===================================== -->

 <div class="row placeholders">
  <p>View Sales by as per Category</p>
...
$sql1="SELECT c.CAT_ID,c.CAT_DESC, SUM(a.QTY) as QTY,SUM(a.PRICE) as PRICE FROM `day_order_dtl` a join f_item b on a.ITEM_ID=b.ITEM_ID join f_cat c on c.CAT_ID=b.CAT_ID where a.TR_ID in (SELECT TR_ID from day_order_hdr ) group by c.CAT_ID,c.CAT_DESC ";
