...
<nav class="main-menu">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" style="margin-top: 60px">Delete Item</h1>
...
<?php
 ...
 require ("../conn.php");
  ...
  $query = "SELECT ITEM_ID, ITM_DESC FROM f_item";
  ...
  while($r = mysqli_fetch_array($result)) {
    echo "<option style=\"color:black\"; value=".$r['ITEM_ID'].">".$r['ITM_DESC']."</option>";
  }
  echo "</select>";
...
<?php
 ...
 $id = $_POST['dropdown'];
 $sql = "DELETE FROM f_item WHERE ITEM_ID='$id'";
