...
<nav class="main-menu">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" style="margin-top: 60px;">Add Item</h1>
...
<tr>
       <th> ITEM DESC</th> <th><input type="text" style="color:black"; name="tableno1" /></th><br /></tr>

<tr>
       <th> PRICE </th> <th><input type="text" style="color:black"; name="tableno3" /></th><br /></tr>
...
<?php
  ...
  echo "<select style=\"color:black\"; name='dropdown' ><option>Select</option>";
...
?>
 ...
 <tr>
        <th></th><th> <input style="color: black;" type="submit" name="submit" value="Add Item" /></th>
