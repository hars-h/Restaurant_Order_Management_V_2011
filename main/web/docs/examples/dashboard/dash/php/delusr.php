...
<nav class="main-menu">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" style="margin-top: 60px">Remove User</h1>
 ...
 $query = "SELECT U_ID, U_NAME FROM app_user";
  ...
  while($r = mysqli_fetch_array($result)) {
    echo "<option style=\"color:black\"; value=".$r['U_ID'].">".$r['U_NAME']."</option>"; 
  }
  echo "</select>";
 ...
 echo "<INPUT style=\"color: black;\" TYPE=\"SUBMIT\" name=\"SUBMIT\" Value=\"Submit\"/>";
 

 if(isset($_POST['dropdown'])) {
 $id = $_POST['dropdown'];
 $sql = "DELETE FROM app_user WHERE U_ID='$id'";
