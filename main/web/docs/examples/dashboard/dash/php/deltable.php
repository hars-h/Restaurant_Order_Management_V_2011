...
<nav class="main-menu">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header" style="margin-top: 60px">Delete Table</h1>
...
<BODY>
 ...
 $query = "SELECT TABLE_NO, FLAG FROM f_table";
  ...
  echo "<select style=\"color:black\"; name='dropdown' style=\"color:black\"; value=''><option>Select</option>";
  while($r = mysqli_fetch_array($result)) {
    echo "<option style=\"color:black\"; value=".$r['TABLE_NO'].">".$r['TABLE_NO']."</option>"; 
  }
  echo "</select>";
...
<?php
 ...
 $id = $_POST['dropdown'];
 $sql = "DELETE FROM f_table WHERE TABLE_NO='$id'";
