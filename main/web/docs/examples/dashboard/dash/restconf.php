...
<!--===================================== -->
 ...
 <div class="row placeholders">
       ...
       <a href="php/addfcat.php"> <button type="button" style=" width: 100px; height: 100px;">Add Food Category</button></a>
        ...
        <a href="php/addtable.php"><button type="button" style=" width: 100px; height: 100px;">Add New Table</button></a>
        ...
        <a href="php/addfitem.php"><button type="button" style="width: 100px; height: 100px;">Add Food Item</button></a>
 ...
 <div class="row placeholders">
       ...
       <a href="php/delfcat.php"> <button type="button" style=" width: 100px; height: 100px;">Delete Food Category</button></a>
        ...
        <a href="php/deltable.php"><button type="button" style="width: 100px; height: 100px;">Delete Table</button></a>
        ...
        <a href="php/delfitem.php"><button type="button" style=" width: 100px; height: 100px;">Delete Food Item</button></a>
       ...
       <a href="php/addtax.php"> <button type="button" style="background: url(img/tax.png) no-repeat center;  width: 100px; height: 100px;"></button></a>
                    </div>
</div>
