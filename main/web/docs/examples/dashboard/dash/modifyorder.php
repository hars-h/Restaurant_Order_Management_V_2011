...
if(!$_SESSION['login']){
  ...
  <nav class="main-menu">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin-top: 20px;">
          <h1 class="page-header">Modify Order</h1>
    ...
    while($row = $result->fetch_assoc()) {
            ...
            echo "<form action=\"modtable.php\" method=\"post\">
...
<div id="modform" style=" align-text: center; padding-top: 20px;">
              <form action="modorder.php" method="post" style="color: black;">
              <input type="text" name="tableid" placeholder="table no"><br/>
			  <input type="text" name="trid" placeholder="transaction id"><br/>
