...
#cartlist {
  ...
  <body id="background" style="margin-top: 60px;">
...
echo "<ul><button style=\"width: 100%; color:black; height: 50px;
    padding: 1px 1px 1px 1px;\"  class=\"category\" value=".@$row["CAT_ID"]." data-catid=".@$row["CAT_ID"]." type=\"submit\">".@$row["CAT_DESC"]." </button></ul>";
